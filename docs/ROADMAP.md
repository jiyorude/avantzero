...
*Current Version: 0.2.0 - September 15th, 2025*
...
| 0.1.0 | Preparation | **Software:** ~~File- and folder structure ready~~, ~~outline of algorithm functions and helper function definitions.~~ **Documentation Website:** ~~Loading screen.~~ ~~Homepage layout ready (a11y, responsive),~~ ~~i18n implementation for Dutch and English~~ | **100% - 15/09/2025** |
| 0.2.0 | Splash Screen / Main Menu | **Software:** Completed Loading/Splash screen, completed splash helper functions, main menu completed with full functionality, user can terminate out of the program. **Documentation website:** Errors are properly documented alongside fixes, homepage of ~~Documentation Website has clickable buttons leading to empty pages, responsivity, a11y, i18n, fully working loading screen~~, loading screen animation, 404 page design + autoreturn to home, padding fixes tablet query, Dark Theme | *10%* |
...
| 0.3.0 | Documentation: Background, Requirements, Installation | **Documentation:** Completed background chapter on documentation website, completed requirements chapter on documentation website, completed installation chapter on documentation website, all pages are a11y-compliant, responsive and accessible in Dutch and English, user can switch languages at will. Page components for text, images and headers have been completed | 0% |
