...
| 0.1.0 | Preparation | **Software:** ~~File- and folder structure ready~~, ~~outline of algorithm functions and helper function definitions.~~ **Documentation Website:** Loading screen and Homepage layout ready (a11y, responsive), i18n implementation for Dutch and English | *40%* |
