...
The Avant and AvantZero logo's use a typeface named 'Valorant', created by typeface artist Bryan T and obtained from dafont.com with a 100% free license. The logo's designed for the Avant and AvantZero algorithms are custom-designed with the aid of this font and are not intended to represent Valorant and/or anything related to the game and publisher/developer or to be affiliated with Valorant, and/or Riot games in any way, shape or form. <br>
